# PPWCode.AspNetCore.API

This library is part of the .NET PPWCode project and serves as the base for the API project in a REST API solution implemented with ASP.NET Core.
